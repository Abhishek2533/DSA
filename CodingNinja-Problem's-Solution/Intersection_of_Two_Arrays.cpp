...
Intersection of the two arrays in an array that consists of all the common elements occuring in both arrays.

Note:
1. The length of rach array is greater than zero.
...
The first ilne of each test case contains two integers N M, denoting the size of the two arrays.
